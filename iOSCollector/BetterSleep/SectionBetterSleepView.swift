...
struct SectionBetterSleepView: View {
        ...
        NavigationView {
            Form {
                ...
                Section(header: Text("Daily coffee intake").font(.headline)){
                    Picker("cpu(s) of coffee", selection: $coffeeAmount) {
                        ForEach(1 ..< 10) {
                            if $0 == 1 {
                                Text("1  cup")
                            } else {
...
struct SectionBetterSleepView_Previews: PreviewProvider {
    static var previews: some View {
        SectionBetterSleepView()
    }
}
